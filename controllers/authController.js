...
export const registerCustomer = async (req, res) => {
	const { username, firstname, middlename, lastname, mobile_no, password, email } = req.body;

	try {
		const existing = await checkIfExists('customer', ['username', 'email'], [username, email]);
...
export const registerAdmin = async (req, res) => {
	const { username, firstname, middlename, lastname, role_id, password, email } = req.body;

	try {
		const existing = await checkIfExists('admins', ['username', 'email'], [username, email]);
